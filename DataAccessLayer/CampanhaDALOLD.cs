...
{
    public class CampanhaDALOLD
    {

        private SQLServerConexion SqlConnection; // = new SQLServerConexion("headin2023fabrinioandessantanalemos");

        public CampanhaDALOLD()
        {
            Funcoes.LogError(" CampanhaDAL()", "");
            teste tes = new teste("headin2023fabrinioandessantanalemos");
            Funcoes.LogError("teste tes = new teste();", "");
          //  SqlConnection = new SQLServerConexion();
          //  Funcoes.LogError("SqlConnection = new SQLServerConexion();", "");
          //  SqlConnection.Open();
        }
