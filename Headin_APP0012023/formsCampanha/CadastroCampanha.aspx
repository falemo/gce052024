<%@ Page Title="Demolay Sergipe" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CadastroCampanha.aspx.cs" Inherits="Headin_APP0012023.CadastroCampanha" %>
        ...
        <asp:GridView ID="GridViewCampanha" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataKeyNames="id" OnRowEditing="GridViewCampanha_RowEditing" 
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="lblIdPessoa" runat="server" Text='<%# Eval("nome") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtEditIdPessoa" runat="server" Text='<%# Bind("nome") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
